...
public class Player extends Entity implements MouseListener{
    ...
    //bara tempor√§r kod f√∂r att testa kollision
    public void update() {
        if(dy < 0)dy = 0;//don't even know (jo det g√∂r jag)
    ...
    public void render(Screen screen) {
        screen.renderSprite(sprite, Gyarb.WIDTH / 2 - sprite.width / 2, Gyarb.HEIGHT / 2 - sprite.height / 2,
        		/*om man gÂr Ât v‰nster sÂ ska spelaren renderas flippad i x led*/dir == Direction.LEFT, false);
